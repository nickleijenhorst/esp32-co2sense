...
void setup()
{
  ...
  airSensor.setAmbientPressure(1015); //Current ambient pressure in mBar: 700 to 1200, will overwrite altitude compensation

  airSensor.setTemperatureOffset(4.0); //Optionally we can set temperature offset to 5°C, stored in non-volatile memory of SCD30
